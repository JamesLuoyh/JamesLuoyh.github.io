...
1. **Scalable and Efficient Temporal Graph Representation Learning via Forward Recent Sampling.**  
   ...
   *Learning on Graphs Conference (LoG)*, 2024.  
   [[arXiv]](https://arxiv.org/abs/2402.01964), [[poster]](/files/NLB_Poster.pdf), [[code/data]](https://github.com/Graph-COM/NLB)
1. **Neighborhood-aware Scalable Temporal Network Representation Learning.**  
   ...
   *Learning on Graphs Conference (LoG)*, 2022. ***Best Paper Award***.  
   [[arXiv]](https://arxiv.org/abs/2209.01084), [[poster]](/files/NAT_Poster.pdf), [[code/data]](https://github.com/Graph-COM/Neighborhood-Aware-Temporal-Network), [[talk]](https://www.youtube.com/watch?v=S9izBSTkk9Q)
